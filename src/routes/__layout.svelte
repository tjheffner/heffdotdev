...
<div class="flex flex-col justify-center bg-gray-50 px-4 py-12 dark:bg-slate-900 sm:px-8">
	<Nav />
</div>
<!-- skip link added in nav -->
<main id="maincontent" class="flex flex-col justify-center bg-gray-50 px-4 dark:bg-slate-900 sm:px-8">
	<slot />
</main>
