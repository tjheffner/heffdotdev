...
<section class="mx-auto flex w-full flex-col items-start px-4 sm:p-0">
	...
	<Slice title="Professional" prose={false}>
		...
		<p class="text-lg font-bold text-orange-600 dark:text-lime-500">Other clients</p>
		<p class="mb-8 text-slate-800 dark:text-gray-400">
			Department of Veterans Affairs, Epic Games, Crossfit, Norwegian Cruise Line, PGA Tour, Weight
			Watchers, Urban Institute, Wilson Center
		</p>
