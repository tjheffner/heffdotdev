...
<svelte:head>
	...
	{:else}
		...
		<meta
			name="twitter:card"
			content={`https://heffner.dev/og?message=${json.title}` ? 'summary_large_image' : 'summary'}
		/>
...
>
	...
	>
		...
		<p class="flex min-w-32 items-center text-sm text-gray-600 md:mt-0 dark:text-gray-400">
